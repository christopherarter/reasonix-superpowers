...
[ "$count" = "11" ] || { echo "FAIL: expected 11 skill dirs, got $count"; exit 1; }
...
[ "$(wc -l < "$root/.superpowers-reasonix/manifest" | tr -d ' ')" = "11" ] || { echo "FAIL: manifest should list 11 dirs"; exit 1; }
...
[ "$count2" = "11" ] || { echo "FAIL: re-run left $count2 skill dirs"; exit 1; }
